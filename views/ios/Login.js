		...
		return (
			<View style={LoginTheme.container}>
				...
				<View style={LoginTheme.box}>
					...
					<View style={LoginTheme.errorWrapper}>
						<Text style={LoginTheme.errorMessage}>{this.state.error}</Text>
					</View>
				</View>
			</View>
		);
